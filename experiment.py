...
def main(result_file):
    ...
    for model_def, dataset_def in zip(models, datasets):
        ...
        trained_ner_model, model_out_path, best_result = (
            train.train_model(model_config, dataset_config, label_list, training_params,
                              tokenized_dataset, tokenizer, save_strategy="epoch"))
        ...
        if results is None:
            ...
            results = pd.concat([results, pd.DataFrame([result])], axis=1)
